...
class SCS(object):
    ...
    def calcula_matriz_cargas(self):
        ...
        for i in range(len(self.sub_bacias)):
            ...
            # vetor_cargas = [carga_DBO, carga_NTK, carga_NOX, carga_PINORG, carga_COL]

            matriz_cargas.append(vetor_cargas)
            vetor_cargas = []

        # matriz_cargas = matriz n° subbacias x 4, com vetores [carga_DBO, carga_NTK, carga_NOX, carga_PINORG, carga_COL]
