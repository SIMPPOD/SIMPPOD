...
class Euler(object):
    ...
    @staticmethod
    def ordena_matriz_contribuicoes(matriz_contribuicoes, tributarios, celula_entrada_tributario):
    ...
    def Calcula(self, Rio, matriz_contribuicoes, matriz_tipo_contribuicoes, simula_difusa, tributarios, celula_entrada_tributarios):
        ...
        if tributarios:
            [matriz_contribuicoes, matriz_tipo_contribuicoes] = self.ordena_matriz_contribuicoes(matriz_contribuicoes, tributarios, celula_entrada_tributarios)
