...
class Populacao:
    ...
    def __init__(self, pe, tam_populacao, tam_cromossomo, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual,
                 ef_minima, numFuncao, simula_difusa, vetor_pesos_pontual, vetor_pesos_difusa, scs, modo_otimizacao, matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios):
        ...
        for i in range(int(tam_populacao)):
            ...
            individuo.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, numFuncao, matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios)
            while not individuo.isValido(Rio, numFuncao):
    ...
    def cruzamento(self, ind1, ind2, pe, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual, scs, tributarios, celula_entrada_tributarios):
        filhos_invalidos = 0
        if self.modo_otimizacao == 1:
            if self.simula_difusa: 
                while True:
                    ...
                    filho.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, self.numFuncao, self.matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios)  # Seta o cenario
                ...
                while True:
                    ...
                    filho.set_alelos(alelos_filho)
                    filho.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, self.numFuncao, self.matriz_tipo_contribuicoes) 
            ...
            if self.simula_difusa:
                while True:
                    ...
                    filho.set_alelos(alelos_filho)
                    filho.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, self.numFuncao, self.matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios)
    ...
    def gera_mutante(self, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual, scs, tributarios, celula_entrada_tributarios):
        ...
        mutante.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, self.numFuncao, self.matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios) 
    ...
    def gera_prox_geracao(self, NE, NC, NM, pe, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual, scs, tributarios, celula_entrada_tributarios):
        tempo_inicial = time.time()
        ...
        if self.modo_otimizacao == 1:
            ...
            for i in range(int((NC+NE)*self.tam_populacao)):  # i varia de 0 ao tamanho da populacao da nao-elite
                ...
                [filho, filhos_invalidos] = self.cruzamento(individuo1, individuo2, pe, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual, scs, tributarios, celula_entrada_tributarios)
            ...
            for i in range(int(NM * self.tam_populacao)):  # i varia de 0 ao tamanho da populacao mutante
                mutantes.append(self.gera_mutante(matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual, scs, tributarios, celula_entrada_tributarios))
