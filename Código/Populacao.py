...
class Populacao:
    ...
    def __init__(self, pe, tam_populacao, tam_cromossomo, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual,
        ...
        for i in range(int(tam_populacao)):  # Para cada individuo na populacao
            ...
            individuo.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, numFuncao, matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios)  # Seta o cenario
    ...
    def gera_mutante(self, matriz_contribuicoes, Rio, qual_ufmg, matriz_reducao_pontual, scs, tributarios, celula_entrada_tributarios):
        ...
        mutante.exec_QualUFMG(qual_ufmg, Rio, matriz_contribuicoes, matriz_reducao_pontual, scs, self.numFuncao, self.matriz_tipo_contribuicoes, tributarios, celula_entrada_tributarios)  # Seta o cenario
