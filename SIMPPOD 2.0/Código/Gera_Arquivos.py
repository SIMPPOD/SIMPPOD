...
def converte_float(valor):
    if type(valor) is list: valor = valor[0]
    if system() != "Linux":
...
def gera_saida_base_pontual(caminho_entrada, diretorio_saida, cenario_pontual, tam_rio, tam_cel):
...
def gera_saida_base_difusa(caminho_entrada, diretorio_saida, cenario_difusa, tam_rio, tam_cel):
    arquivo_entrada = "/" + caminho_entrada.split("/")[-1].split(".")[0]
    diretorio_saida += arquivo_entrada
    checa_diretorio(diretorio_saida)
...
def gera_saida_base_pontual_difusa(caminho_entrada, diretorio_saida, cenario_pontual, cenario_difusa, tam_rio, tam_cel):
    arquivo_entrada = "/" + caminho_entrada.split("/")[-1].split(".")[0]
    diretorio_saida += arquivo_entrada
    checa_diretorio(diretorio_saida)
...
def gera_saida_estimar_cargas(caminho_entrada, diretorio_saida, cenario_difusa):
    arquivo_entrada = "/" + caminho_entrada.split("/")[-1].split(".")[0]
    diretorio_saida += arquivo_entrada
    checa_diretorio(diretorio_saida)
...
def gera_saida_otimizado_pontual(caminho_entrada, diretorio_saida, cenario_base_pontual, melhor_solucao_pontual, melhor_solucao_pontual_rapida, tam_rio, tam_cel, tempo_pontual, tempo_pontual_rapida, vetor_invalidos_pontual, vetor_invalidos_pontual_rapida):
    if melhor_solucao_pontual_rapida is not None:
        arquivo_entrada = "/" + caminho_entrada.split("/")[-1].split(".")[0]
        diretorio_saida += arquivo_entrada
        checa_diretorio(diretorio_saida)
...
def Escreve_Amonia_Livre(arquivo, cenario):
    ...
    for i in range(len(cenario.Amonia[0])):
...
def Escreve_Amonia_Ionizada(arquivo, cenario):
    ...
    for i in range(len(cenario.Amonia[1])): 
...
def Escreve_K2(arquivo, cenario):
    ...
    for i in range(len(cenario.PerfilK2)): 
...
def Escreve_Kd(arquivo, cenario):
    ...
    for i in range(len(cenario.PerfilKd)):
...
def Escreve_V(arquivo, cenario):
    ...
    for i in range(len(cenario.PerfilV)): 
...
def Escreve_H(arquivo, cenario):
    ...
    for i in range(len(cenario.PerfilH)):
...
def Escreve_Tempo(arquivo, cenario):
    ...
    for i in range(len(cenario.PerfilTempo)): 
