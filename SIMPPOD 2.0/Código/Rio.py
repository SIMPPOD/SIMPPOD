...
class Rio(object):
    ...
    def __init__(self, tam_rio, tam_cel, classe, T, Alt, PH, DBOr, ODr, NORGr, NAMONr, NNITRIr, NNITRAr, PORGr, PINORGr, COLr,
                 ...
                 b_prof, DBOinc, ODinc, NORGinc, NAMONinc, NNITRIinc, NNITRAinc, PORGinc, PINORGinc, COLinc, Qinc, Sd, Lrd, KM_Jusante, ID, ID_Jusante):
        ...
        self.Lrd = Lrd
        self.Kb = Kb
        self.KM_Jusante = KM_Jusante * 1000 / tam_cel
        self.ID = ID
        self.ID_Jusante = ID_Jusante
